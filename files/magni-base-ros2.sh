...
log info "magni-base: Using workspace setup file /home/ubuntu/ros2_ws/install/setup.bash"
...
log info "magni-base: Launching ROS_HOSTNAME=$ROS_HOSTNAME"

# Punch it.
#export ROS_HOME=$(echo ~ubuntu)/.ros
#xport ROS_LOG_DIR=$log_path
ros2 launch --wait -v magni_bringup base.launch.py
PID=$!

#log info "magni-base: Started roslaunch as background process, PID $PID, ROS_LOG_DIR=$ROS_LOG_DIR"
log info "magni-base: Started roslaunch as background process, PID $PID"
