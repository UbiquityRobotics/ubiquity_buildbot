...
class customizeImage:
	...
	def execute_customizations(self):
		...
		subprocess.run("git clone https://MoffKalast:$GIT_TOKEN@github.com/UbiquityRobotics/ezmap_pro.git", shell=True, check=True, executable='/bin/bash')
		...
		subprocess.run("bash -c \"echo 'source /home/ubuntu/catkin_ws/src/ezmap_pro/ezmap_bringup/scripts/ros_log_clean.bash' >> /etc/ubiquity/env.sh\"", shell=True, check=True, executable='/bin/bash')	
